    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] rounded-2xl max-h-[85vh] overflow-y-auto">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              {photos.length < 4 && (
                <button
                  ...
                  className="h-16 w-16 rounded-xl border-2 border-dashed border-primary/30 flex flex-col items-center justify-center gap-0.5 text-primary/50 hover:border-primary/50 hover:bg-primary/5 transition-all"
                >
                  <Camera className="h-4 w-4" />
                  <span className="text-[0.5rem]">Add</span>
                </button>
              )}
            </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={submitting} className="rounded-xl text-xs">
